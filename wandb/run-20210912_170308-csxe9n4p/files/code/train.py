...
# Start a new run
wandb.init(project='bird-classification', entity='skycladai')
...
def train(args):
    ...
    # We are spliting our data (the wav files) into shuffle test(30%) and train(70%)
    ...
    model.fit(tg, validation_data=vg,
              epochs=40, verbose=1,
              callbacks=[csv_logger, cp, WandbCallback()])
